      ...
      <div class="col-12 col-md-12 ">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php echo form_open_multipart('data_indikator/tambah'); ?>
            <form>
            ...
            <div class="form-group row mb-3 ml-2">
                <div class="col-sm-12 col-md-11">
                  ...
                  <input type="text" name="usia" class="form-control " placeholder="Masukan Rentang Usia(0-12)"  required >
              ...
              <div class="form-group row mb-3 ml-2">
                <div class="col-sm-12 col-md-11">
                  ...
                  <input type="text" name="tinggi" class="form-control" placeholder="Masukan Tinggi Badan Maksimal..." required>
                </div>
              </div>
              <div class="form-group row mb-3 ml-2">
                <div class="col-sm-12 col-md-11">
