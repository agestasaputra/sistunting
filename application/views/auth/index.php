...
<body>
  <div id="app">
    <div class="container mt-5">
      <div class="row ">
        <div class="col-lg-4 ">
          <h3 class=" mt-5 text-dark font-weight-normal text-center mb-5"> <span class="font-weight-bold">LOGIN</span></h3>
          <?= $this->session->flashdata('notif'); ?>
          <?php echo form_open_multipart('auth/proses_login'); ?>
        ...
        <div class="col-lg-6 ">
          <div>
            <img src="<?= base_url(); ?>assets/img/logos1.png" class="  w-100 mt-5 ">
          </div>
        </div>
      </div>
    </div>
